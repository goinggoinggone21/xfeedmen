...
all_urls_fn = 'all_ava_feed_urls_ever.ob'
try:
...
#Load Reddits
reddits_with_redgif = [x for x in reddit.subreddit('AvaAddams').top(time_filter='year',limit=1000) if ('redgifs' in x.url)]
reddits_with_redgif = reddits_with_redgif + [x for x in reddit.subreddit('AvaAddams').top(time_filter='month',limit=1000) if ('redgifs' in x.url)]
reddits_with_redgif = reddits_with_redgif + [x for x in reddit.subreddit('AvaAddams').top(time_filter='all',limit=1000) if ('redgifs' in x.url)]
